...
#define SecondTitleFont  [UIFont systemFontOfSize:14]
#define MainTitleFont  [UIFont systemFontOfSize:16]
#define NavtitleFont  [UIFont systemFontOfSize:18]

#define System11 ([UIDevice currentDevice].systemVersion.floatValue > 11.0f)
